...
class SmartMail_Software_Store {
    ...
    private function __construct() {
        ...
        $this->register_custom_post_types(); // Add this line to initialize custom post types
    }
    ...
    private function register_custom_post_types() { // Add this function to register custom post types
...
### Complete the Registration Code:

Here is the complete code for registering both the eBooks and Software custom post types:
